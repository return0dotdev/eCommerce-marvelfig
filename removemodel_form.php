...
<br />
    <br />
    <div class="container" >
    <h3 class="my-4" >Remove Information Model</h3>
    <form class="needs-validation" novalidate method="post" action="removemodel.php">
      <div class="form-row">
        <div class="col-md-6 mb-5">
          <label for="validationCustom01">ID_Product</label>
          <input type="text" class="form-control" name="product_id" id="validationCustom01" placeholder="ID">
