...
<header>  <!-- Navigation -->
  ...
  <div class="container">
    ...
    <form name="from1" method="post" action="updatehero.php" enctype="multipart/form-data">
    <div class="form-group">
        <label for="exampleInputEmail1">HERO ID</label>
        <input type="text" class="form-control" name="hero_id" placeholder="Hero_ID">
      </div>
      <div class="form-group">
